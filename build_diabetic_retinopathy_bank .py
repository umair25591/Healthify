...
folder = 'diabetic_retinopathy_samples'
feature_bank = {}
...
with open('model/diabetic_retinopathy_feature_bank.pkl', 'wb') as f:
    pickle.dump(feature_bank, f)

print("✅ X-ray feature bank created at model/diabetic_retinopathy_feature_bank.pkl")
